import sportsmans from './sportsmans220909.js';
import sportsmansPrevious from './sportsmansPrevious220905.js';
import prizes from './prizes220909.js';
...
.then(function(data) {
  ...
  let num = 1;
  for (let item of players) {
    if (arrSportsmansPrevious.includes(item.getElementsByTagName('column')[1].lastChild.nodeValue.toLowerCase()) && num < 56) {
      const li = document.createElement('li');
      const span = document.createElement('span');
